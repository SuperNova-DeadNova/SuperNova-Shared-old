...
namespace SuperNova.DB {
    ...
    public static class DBUpgrader {
        ...
        public static string[] CompactMessages = new string[] {
            ...
            "   a) doing VACUUM on the database (note that this will create a temp file as big as SuperNova.db)",
            "   b) doing /server backup litedb, shutting down the server, deleting SuperNova.db, then finally running /server import SQL",
        };
